...
# تم تقليل الارتفاع بـ 19 بكسل ≈ 5 ملم
WIDTH, HEIGHT = 2048, 493
BAR_HEIGHT = 81
AVATAR_SIZE = (512, HEIGHT - BAR_HEIGHT)
...
def generate_banner():
    ...
    draw.text((512 + 20, (BAR_HEIGHT - h_dev) // 2), dev_text, font=font_dev, fill="white")
